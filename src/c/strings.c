...
// aber auch nur den Zwei-Buchstaben-Code liefern. Deshalb wird NIE auf
// "de_DE" verglichen, sondern auf die ersten zwei Zeichen - so wird auch eine
// Schweizer Uhr (de_CH, fr_CH, it_CH) richtig erkannt.
